...
export const append = async (productId, materialId, cellshapeId, edgingId, bodyId, trunkId, thirdrowId, saddleId, steelId, organizerId, organizerfiftyId, quantity, quantity_trunk, quantity_organizer, quantity_organizerfifty) => {
    const { data } = await guestInstance.post(`basket/append`, {materialId, productId, cellshapeId, edgingId, bodyId, trunkId, thirdrowId, saddleId, steelId, organizerId, organizerfiftyId, quantity, quantity_trunk, quantity_organizer, quantity_organizerfifty});
    return data;
}
