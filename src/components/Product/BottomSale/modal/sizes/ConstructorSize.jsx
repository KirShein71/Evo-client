...
function ConstructorSize({
  ...
  return (
    <div className="constructor-size">
      <div className="constructor-size__title">Выберите размер</div>
      <div className="constructor-size__content">
        <div className="constructor-size__content-size">
            ...
            <>
              <div key={bagSize.id}>
                <div className="checkbox" style={{ display: 'flex' }}>
                  ...
                  <div className="constructor-size__checkbox">
        ...
        <div className="constructor-size-equipment__quantity">
          <button
            className="constructor-size-equipment__minus"
            onClick={() => setBagSizeQuantity(bagSizeQuantity - 1)}
            disabled={isCountBagSizeDisabled}>
            <img src="../img/minus.png" alt="minus" />
          </button>
          <div className="constructor-size-equipment__total">{bagSizeQuantity}</div>
          <button className="constructor-size-equipment__plus">
            <img
              src="../img/plus.png"
              alt="plus"
              onClick={() => setBagSizeQuantity(bagSizeQuantity + 1)}
