      ...
      <div className="product__content">
        <div className="product__content-left">
          ...
          <div className="product__content-equipment">
            <div className="product__content-equipment__title">Выберите комплектацию</div>
            {thirdrow.length > 0 ? (
            ...
            <div className="product__content-equipment__trunk">
              {trunk?.map((trunk) => (
                <div key={trunk.id}>
                  ...
                  <div className="product__content-equipment__price">
                    <div className="product__content-equipment__oldPrice">
                      {trunk.old_price * trunkQuantity} Р
                    </div>
                    <div className="product__content-equipment__newPrice">
                      {trunk.new_price * trunkQuantity} Р
                    </div>
                  </div>
                  <div className="product__content-equipment__quantity">
                    <button
                  ...
                  <div className="trunk__image">
                    <img src="../img/trunk.png" alt="trunk_schema" />
                    <div className="image__sxema-bottom">Образец лекал в багажник</div>
                  </div>
                </div>
              ))}
            </div>
        ...
        <div className="product__content-right">
          ...
          <div className="product__content-body">
            <div className="product__content-body__title">Выберите тип кузова</div>
