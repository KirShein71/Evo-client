...
import { getOneHome } from '../../http/homeApi';
...
function HomeProductInfo() {
  const { id } = useParams();
  const [fetching, setFetching] = React.useState(true);
  const [homeProduct, setHomeProduct] = React.useState();
  ...
  React.useEffect(() => {
    ...
    const fetchData = async () => {
      const homeProductData = await getOneHome(id);
      setHomeProduct(homeProductData);
      ...
      if (homeProductLoaded && materialLoaded && edgingLoaded) {
        setFetching(false);
      }
    };
  ...
  const clickToCart = (homeId, materialId, edgingId, quantity) => {
    appendHome(homeId, materialId, edgingId, quantity)
      .then((data) => {
  ...
  return (
    <div className="homeproduct">
      <div className="container">
        <div className="homeproduct__title">{homeProduct?.name}</div>
        <div className="homeproduct__content">
          <div className="homeproduct__content-left">
            <div className="homeproduct__content-image">
              <img src={process.env.REACT_APP_IMG_URL + homeProduct?.image} alt="animals" />
            </div>
          </div>
          <div className="homeproduct__content-right">
            <div className="homeproduct__content-color">
              <div className="homeproduct__content-color__title">
                Цвет коврика: {selectedMaterialName}
              </div>
              <div className="homeproduct__content-color__items">
                {materials.map((material) => (
                  <div
                    ...
                    <div
                      className={`homeproduct__content-color__item ${material.color} ${
              ...
              <div className="homeproduct__content-edging">
                <div className="homeproduct__content-edging__title">
                  Цвет канта: {selectedEdgingName}
                </div>
                <div className="homeproduct__content-edging__items">
                  {edgings.map((edging) => (
                    <div
                      key={edging.id}
                      onClick={() => {
                      ...
                      <div
                        className={`homeproduct__content-edging__item ${edging.color} ${
            ...
            <div className="homeproduct__content-equipment">
              ...
              <div className="homeproduct__content-equipment__interior">
                ...
                <div className="homeproduct__content-equipment__quantity">
                  <button
                    className="minus"
                  ...
                  <div className="homeproduct__content-equipment__total">{quantity}</div>
                ...
                <button
                  onClick={() => {
                    if (isAddedToCart) {
                      ...
                      clickToCart(homeProduct.id, selectedMaterialId, selectedEdgingId, quantity);
                    }
                  }}
                  type="button"
                  id="homeproduct__button"
