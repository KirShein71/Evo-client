...
import { createAnimalImage } from '../../../../http/animalApi';
...
const CreateAnimalImage = (props) => {
  const { show, setShow, setChange, animalId } = props;
  ...
  const handleSaveImages = () => {
    ...
    Promise.all(data.map(createAnimalImage))
      .then(() => {
        setSelectedImages([]);
        setShow(false);
...
export default CreateAnimalImage;
